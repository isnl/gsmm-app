...
import {
  ...
  auxiliaryMeasureOptions,
  aerialSeedingUnqualifiedReasonOptions,
  generateYearOptions,
} from './constants';
    ...
    <view class="px-20px py-20px">
      ...
      <view class="mb-30px">
        ...
        <view class="mb-20px">
          ...
          <view class="mb-15px">
            <view class="mb-8px">
              <text class="text-14px color-#666">树（草）种</text>
            </view>
            <uni-easyinput v-model="localFormData.c12" placeholder="结合现地调查和查阅内业资料确定" :clearable="true"></uni-easyinput>
          </view>
          ...
          <view class="mb-15px">
            ...
            <view class="flex items-center gap-10px">
              <view class="flex-1">
                <uni-easyinput v-model="localFormData.c13" type="number" placeholder="通过查阅内业资料确定" :clearable="true"></uni-easyinput>
              </view>
          ...
          <view class="mb-15px">
            <view class="mb-8px">
              <text class="text-14px color-#666">辅助措施</text>
            </view>
            <MultiSelector v-model="localFormData.c14" :options="auxiliaryMeasureOptions" placeholder="可多选，用'+'号连接" />
          </view>

          <!-- 有效苗株数 -->
          <view class="mb-15px">
            <view class="mb-8px">
              <text class="text-14px color-#666">有效苗株数</text>
            </view>
            <view class="flex items-center gap-10px">
              <view class="flex-1">
                <uni-easyinput v-model="localFormData.c15" type="number" placeholder="按现地调查结果填写" :clearable="true"></uni-easyinput>
              </view>
              <text class="text-14px color-#666">株/hm²</text>
            </view>
          </view>
          ...
          <view class="mb-15px">
            <view class="mb-8px">
              <text class="text-14px color-#666">有苗样地频度</text>
            </view>
            <view class="flex items-center gap-10px">
              <view class="flex-1">
        ...
        <view class="mb-15px">
          ...
          <view class="flex items-center gap-10px">
            <view class="flex-1">
              <uni-easyinput v-model="localFormData.c17" type="number" placeholder="质量达到合格标准的，合格面积以核实面积计" :clearable="true"></uni-easyinput>
            </view>
            <text class="text-14px color-#666">亩</text>
          </view>
        </view>
        ...
        <view class="mb-15px">
          ...
          <MultiSelector v-model="localFormData.c18" :options="aerialSeedingUnqualifiedReasonOptions" placeholder="可多选，用'+'号连接" />
        </view>
      </view>
      ...
      <view class="mb-30px">
        ...
        <view class="mb-15px">
          ...
          <uni-easyinput v-model="localFormData.c19" type="textarea" placeholder="对填写'其他'的情况进行说明" :clearable="true"></uni-easyinput>
        </view>
      </view>
    </view>
  </view>
