...
import {
  ...
  grassPlantingMeasureOptions,
  artificialGrasslandUnqualifiedReasonOptions,
  generateYearOptions,
} from './constants';
    ...
    <view class="px-20px py-20px">
      ...
      <view class="mb-30px">
        ...
        <view class="mb-20px">
          ...
          <view class="mb-15px">
            <view class="mb-8px">
              <text class="text-14px color-#666">种草措施</text>
            </view>
            <uni-data-select v-model="localFormData.c13" :localdata="grassPlantingMeasureOptions" placeholder="请选择种草措施"></uni-data-select>
          </view>
          ...
          <view class="mb-15px">
            ...
            <view class="flex items-center gap-10px">
              <view class="flex-1">
                <uni-easyinput v-model="localFormData.c16" type="number" placeholder="按调查结果填写" :clearable="true"></uni-easyinput>
              </view>
          ...
          <view class="mb-15px">
            ...
            <view class="flex items-center gap-10px">
              <view class="flex-1">
                <uni-easyinput v-model="localFormData.c17" type="number" placeholder="按调查结果填写" :clearable="true"></uni-easyinput>
              </view>
        ...
        <view class="mb-15px">
          ...
          <view class="flex items-center gap-10px">
            <view class="flex-1">
              <uni-easyinput v-model="localFormData.c18" type="number" placeholder="质量达到合格标准的，合格面积以核实面积计" :clearable="true"></uni-easyinput>
            </view>
            <text class="text-14px color-#666">亩</text>
          </view>
        </view>
        ...
        <view class="mb-15px">
          ...
          <MultiSelector v-model="localFormData.c19" :options="artificialGrasslandUnqualifiedReasonOptions" placeholder="可多选，用'+'号连接" />
        </view>
      </view>
      ...
      <view class="mb-30px">
        ...
        <view class="mb-15px">
          ...
          <uni-easyinput v-model="localFormData.c20" type="textarea" placeholder="对填写'其他'的情况进行说明" :clearable="true"></uni-easyinput>
        </view>
      </view>
    </view>
  </view>
